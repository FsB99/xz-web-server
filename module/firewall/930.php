...
return [
  ...
  [
    ...
    'msg' => 'Path Traversal Attack (/../) or (/.../)',
    'rule' => [
      ['w' => ['uri', 'args', 'header', 'files'], 'rx' => '~(?:^|[\/;\\\\])\.{2,3}(?:[\/;\\\\]|$)~'],
    ],
  ],
  [
    'id' => 930120,
    ...
    'rule' => [
      ['w' => ['cookie', 'args', 'header'], 'rx' => $rx_930120],
    ],
  ],
  [
    'id' => 930130,
